(() => {
    ...
    (() => {
        ...
        let rating = document.querySelector(".form__rating"), ratingItem = document.querySelectorAll(".form__rating-item"), grad = document.querySelector(".form__grad");
        ...
        function removeClass(arr) {
            for (let i = 0, iLen = arr.length; i < iLen; i++) for (let j = 1; j < arguments.length; j++) ratingItem[i].classList.remove(arguments[j]);
        }
        function addClass(arr) {
            for (let i = 0, iLen = arr.length; i < iLen; i++) for (let j = 1; j < arguments.length; j++) ratingItem[i].classList.add(arguments[j]);
        }
